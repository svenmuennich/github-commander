...
commandRunner(async () => {
    ...
    const allProjects = await client.fetchAllResults(client.github.projects.listForOrg, {
        org: orgName,
    });
    ...
    const sourceProjectColumns = await client.fetchAllResults(client.github.projects.listColumns, {
    ...
    const destinationProjectColumns = await client.fetchAllResults(client.github.projects.listColumns, {
    ...
    if (destinationColumn) {
        ...
        const destinationColumnCards = await client.requestGently(client.github.projects.listCards, {
        ...
        destinationColumn = await client.requestGently(client.github.projects.createColumn, {
            name: columnName,
            project_id: destinationProject.id,
        });
    ...
    const sourceColumnCards = await client.fetchAllResults(client.github.projects.listCards, {
    ...
    await GitHubClient.sequentiallyAwaitEach(sourceColumnCards.reverse(), async (card) => {
        ...
        await client.requestGently(client.github.projects.createCard, payload);
    });
});
